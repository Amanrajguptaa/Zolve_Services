...
const Card = ({ id, name, description, price, images }) => {
  ...
  const handleAddToCart = (e) => {
    ...
    addToCart({ id, name, description, price, images }, 1);
  };
